...
$footer_column = $shoppingcart_settings['shoppingcart_footer_column_section'];
	...
	if ( is_active_sidebar( 'shoppingcart_footer_options' ) ) :
		...
		<a title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" target="_blank" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo get_bloginfo( 'name', 'display' ); ?></a> | 
						<?php esc_html_e('Designed by:','zannat'); ?> <a title="<?php echo esc_attr__( 'Zannat', 'shoppingcart' ); ?>" target="_blank" href="<?php echo esc_url( '#' ); ?>"><?php esc_html_e('zannatshop','zannatshop');?></a> |
						<?php  echo '&copy; ' . date_i18n(__('Y','zannatshop')) ; ?> <a title="<?php echo esc_attr__( 'WordPress', 'shoppingcart' );?>" target="_blank" href="<?php echo esc_url( '#' );?>"><?php esc_html_e('woocommerce','shoppingcart'); ?></a>
					</div>
	<?php endif; ?>
